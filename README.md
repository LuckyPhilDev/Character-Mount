...
- 📖 **Mount Journal integration** — right-click any mount in the journal to add or remove it from your character list.
- 🏷️ **Source tags** — colour-coded pills show each mount's origin: Racial, Class, Manual, Suggested, or Rare.
