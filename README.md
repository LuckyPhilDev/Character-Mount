...
- **Excluded mounts**: removed mounts move to their own view, reached by clicking the Excluded line at the bottom of the mount list. Each has a one-click restore that brings back the mount's spec, count-as type, and holiday settings, or an X button to clear the mount out for good.
